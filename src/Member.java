...
public class Member
{
  ...
  private String firstName, middleName, lastName, dateOfBirthString, cellPhone, email, blurb;
  ...
  {
    dateOfBirth = newDOB;
    dateOfBirthString = newDOB.toString();
  }
  public void setDateOfBirthString(String dob) { dateOfBirthString = dob; }
